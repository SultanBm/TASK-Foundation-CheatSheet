...
- `{ }`: is mainly used for `open and close blocks of code`
- `( )`: is mainly used for `functions , loops , if statments,console.log()`
...
```js
// New array
let numbers = [ADD_ANY_NUMBER_HERE];
```
